...
- (UIImage *)imageWithCornerRadius:(CGFloat)radius
{
    ...
    UIBezierPath *uiblazierKos = [UIBezierPath bezierPathWithRoundedRect:CGRectMake( 0, 0, self.size.width, self.size.height) cornerRadius:radius];
    
//    UIBezierPath *uiblazierKos = [UIBezierPath bezierPathWithRect:CGRectMake(1, 1, self.size.width, self.size.height)];
//    UIBezierPath *uiblazierKos = [UIBezierPath bezierPathWithRoundedRect:CGRectMake(1, 1, self.size.width, self.size.height) byRoundingCorners:UIRectCornerAllCorners cornerRadii:radius];
    uiblazierKos.lineWidth = 1.0f;
//    [uiblazierKos stroke];
    //clip image
    
    [uiblazierKos addClip];
